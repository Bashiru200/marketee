    ...
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2">
          <Image src="/logo1.png" alt="Markeetee" width={32} height={32} />
          <span className="font-bold text-lg">Markeetee</span>
        </Link>

        {/* DESKTOP NAV */}
        <nav className="hidden md:flex items-center gap-6">

          <Link href="/search" className="text-sm text-gray-600 hover:text-[#1D9E75] flex items-center gap-1">
            <Search size={14}/> Explore
          </Link>

          <Link href="/map" className="text-sm text-gray-600 hover:text-[#1D9E75] flex items-center gap-1">
            <MapPin size={14}/> Map
          </Link>

          {isOwner && (
            <Link href="/dashboard" className="text-sm text-gray-600 hover:text-[#1D9E75] flex items-center gap-1">
              <LayoutDashboard size={14}/> Dashboard
            </Link>
          )}
          ...
          {!isLoggedIn && (
            <Link href="/auth/signup"
              className="bg-[#1D9E75] text-white text-sm px-4 py-2 rounded-xl font-medium">
              List your business
            </Link>
          )}
          ...
          {isLoggedIn && (
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className="w-8 h-8 rounded-full bg-[#085041] text-white flex items-center justify-center text-xs">
                  {initials}
                </div>
                <ChevronDown size={14}/>
              </button>
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-3 w-56 bg-white rounded-2xl shadow-lg border border-gray-100">
                  ...
                  <div className="py-2">
                    ...
                    <Link href="/account/profile" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-50">
                      <User size={14}/> Profile
                    </Link>

                    <Link href="/account/saved" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-50">
                      <Heart size={14}/> Saved
                    </Link>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t px-4 py-4 space-y-3">
          ...
          <Link href="/search" className="block text-sm">Explore</Link>
          <Link href="/map" className="block text-sm">Map</Link>
          ...
          {!isLoggedIn && (
            <Link href="/auth/signup"
              className="block text-center bg-[#1D9E75] text-white py-2 rounded-xl">
              List your business
            </Link>
          )}

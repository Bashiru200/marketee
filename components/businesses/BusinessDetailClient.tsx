...
export default function BusinessDetailClient({ id }: { id: string }) {
  ...
  const isUnclaimed = !biz?.owner_id
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 py-6">
      ...
      {isUnclaimed && (
        <div className="mt-4 rounded-2xl border border-amber-200 p-4 flex items-center justify-between gap-3 flex-wrap"
          style={{ background: '#FFFBEB' }}>
          <div className="flex items-start gap-3">
            <span className="text-2xl flex-shrink-0">🏪</span>
            <div>
              <p className="font-bold text-sm text-amber-900">Is this your business?</p>
              <p className="text-xs text-amber-700 mt-0.5 leading-relaxed">
                Claim this listing to manage your photos, hours, products, and respond to reviews.
              </p>
            </div>
          </div>
          <button

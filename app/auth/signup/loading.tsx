    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-4xl bg-white border border-gray-100 rounded-2xl overflow-hidden flex" style={{ minHeight: '560px' }}>
        ...
        <div className="flex-1 p-8 lg:p-10 flex flex-col justify-center">
          ...
          {/* Divider and social skeleton */}
          <div className="flex items-center gap-3 my-6">
            <div className="flex-1 h-px bg-gray-100" />
            <div className="h-3 w-8 bg-gray-100 rounded" style={{ animation: 'pulse 2s infinite' }} />
            <div className="flex-1 h-px bg-gray-100" />
          </div>

          {/* Google button skeleton */}
          <div className="h-11 w-full bg-gray-100 rounded-xl mb-4" style={{ animation: 'pulse 2s infinite' }} />
